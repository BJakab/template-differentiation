...
int main(int argc, char** argv) {
	...
	TEST(x / 1,  'x', 5,   5, std::cout);
	TEST(x / x,  'x', 5,   0, std::cout);
	TEST(x ^ 2,  'x', 5,  10, std::cout);
	TEST(2 ^ x,  'x', 5,   2, std::cout);
	TEST(x ^ x,  'x', 5, 3154.49, std::cout);
	TEST(sin(x), 'x', 5, -0.9589, std::cout);
	TEST(cos(x), 'x', 5, 0.28366, std::cout);
	TEST(log(x), 'x', 5, 1.60943, std::cout);
